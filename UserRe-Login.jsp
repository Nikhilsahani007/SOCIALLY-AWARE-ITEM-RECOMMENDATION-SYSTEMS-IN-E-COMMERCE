...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600">Invalid Login Details, Please Try Again !!</h2>
          <div class="clr"></div>
		   ...
		   <p>&nbsp;</p>
            <form id="form1" name="form1" method="post" action="UserAuthentication.jsp">
					...
					<table width="359" border="0" cellspacing="2" cellpadding="2">
                      ...
                      <tr>
                        <td width="145" height="46" align="justify"><span class="style34">
                          <label for="name"><span class="style1">User Name (required)</span></label>
                        </span> </td>
                        <td width="200"><input id="name" name="userid" class="text" /></td>
                      </tr>
                      <tr>
                        <td height="40" align="justify"><span class="style1">Password (required)</span></td>
                      ...
                      <tr>
                        ...
                        <td><span class="style16">
                          ...
                          <span class="style1"><b> New User?</b></span></span><a href="UserRegister.jsp" class="style30 style3 style2"><b> Register </b></a></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
