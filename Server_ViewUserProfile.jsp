...
<%@ include file="connect.jsp" %>
          ...
          <h2 class="style2" style="color:#CC6600">User <%=request.getParameter("uname")%>'s Profile.. </h2>
            ...
            <%
				  ...
				  <h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("Server_ViewFeedbacks")){%>
            <h3 align="center"><a href="Server_ViewFeedbacks.jsp?iname=<%=iname%>&id=<%=one%>" class="style4">Back</a></h3>
			<%}
			else if(type.equalsIgnoreCase("Server_View")){%>
            <h3 align="center"><a href="Server_View.jsp" class="style4">Back</a></h3>
			<%}	
