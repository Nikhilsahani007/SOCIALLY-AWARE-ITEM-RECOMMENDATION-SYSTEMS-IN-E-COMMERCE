...
<head>
<title>Authorize Sellers Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600">Give Authorization to Sellers..</h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
		  	<table width="592" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
                    <tr>
					  ...
					  <td  width="109" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b>Seller Name</b></div></td>
                      ...
                      <td  width="109" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b>User</b></div></td>
                    ...
                    <tr>
					  ...
					  <td height="0" align="center"  valign="middle"><div align="center" class="style5"><span class="style1">
                       <a href="Server_SellerProfile.jsp?type=<%="Server_GiveSellerAuthorization"%>&sname=<%=s1%>" style="color:#CC0033"> <b><%out.println(s1);%></b> </a>
                      </span></div></td>
                      <td width="116" rowspan="1" align="center" valign="middle" ><div class="style5 style37 style54 style55 style22" style="margin:10px 13px 10px 13px;" > <a class="#" id="img1" href="#" >
                          <input  name="image" type="image" src="seller_Pic.jsp?id=<%=i%>" style="width:90px; height:90px;" />
                      </a> </div></td>
          <td height="0" align="center"  valign="middle"><div align="center" class="style3">
                      ...
                      <td valign="middle" height="0" style="color:#000000;"align="center"><div align="center" class="style22 style5 style20 style30 style37">
                          <div align="center" class="style20 style37 style46"><a href="Server_SellerStatus.jsp?id=<%=i%>" class="style2"><b>waiting</b></a></div>
                      </div></td>
                      <%
						}
						else
