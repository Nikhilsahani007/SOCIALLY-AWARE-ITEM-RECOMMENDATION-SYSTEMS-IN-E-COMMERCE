...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600">Seller <%=request.getParameter("sname")%>'s Details.. </h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
            ...
            <%			
						...
						try 
						{
						   	String query="select * from suser where sname='"+sname+"'"; 
            ...
            <tr>
              <td width="195" rowspan="8" ><div class="style7 style26" style="margin:10px 13px 10px 13px;" ><strong><a class="#" id="img1" href="#" >
                  <input  name="image" type="image" src="seller_Pic.jsp?id=<%=i%>" style="width:150px; height:150px;" />
              </a></strong></div></td>
            </tr>
			<tr>
              <td  width="105" height="37" valign="middle" style="color: #660000;"><div align="left" class="style6" style="margin-left:10px;"><b>User</b></div></td>
            ...
            <tr>
              ...
              <td  width="192" valign="middle" height="40" style="color:#CC3300;"><div align="left" class="style66" style="margin-left:20px;">
                          <b><%out.println(s3);%></b>
                </div></td>
            </tr>
            <tr>
            ...
            <%
				  ...
				  <h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("Server_GiveSellerAuthorization")){%>
            <h3 align="right"><a href="Server_GiveSellerAuthorization.jsp" class="style3 style5">Back</a></h3>
			<%}
			else if(type.equalsIgnoreCase("Server_ViewScKeyReq")){%>
            <h3 align="right"><a href="Server_ViewScKeyReq.jsp" class="style5 style3">Back</a></h3>
			<%}	
