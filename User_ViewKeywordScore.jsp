...
<head>
<title>Keyword Score Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600">Number of times Keyword is Searched..</h2>
          <div class="clr"></div>
          <div class="post_content">
		   <p>&nbsp;</p>
           			<table width="350" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
              <tr>
                <td  width="150" valign="middle" height="34" style="color: #660033;"><div align="center" class="style52"><b> Keyword</b></div></td>
                <td  width="206" valign="middle" height="34" style="color: #660033;"><div align="center" class="style52"><b> No Of Times Searched</b></div></td>
              </tr>
              ...
              <%
						...
						try 
						{
							...
							String keyword=""; int score=0;
							
						    
						   	String query="select * from ukeywordscore where user='"+user+"' "; 
            ...
            <tr>
              <td width="468"><div align="right"><a href="User_SearchTransactions.jsp" class="style14">Back</a></div></td>
            </tr>
          </table>
