          ...
          <div class="post_content">
		   <p>&nbsp;</p>
            ...
            <%
				  ...
				  <h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("Seller_UserPurchases")){%>
            <h3 align="right"><a href="Seller_AllUserPurchase.jsp" class="style3 style5">Back</a></h3>
			<%}
			else if(type.equalsIgnoreCase("Seller_View")){%>
            <h3 align="right"><a href="Seller_View.jsp" class="style5 style3">Back</a></h3>
			<%}	
