...
<head>
<title>All User Purchased Cloths Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600">All User Cloth Purchases..</h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
                    ...
                    <tr>
					  ...
					  <td  width="94" valign="middle" style="color: #660033;"><div align="center" class="style13 style4"><b>Purchased From</b></div></td>
					  
					  
					  
                      <td  width="101" valign="middle" style="color: #660033;"><div align="center" class="style13 style4"><b>Purchased Date</b></div></td>
                    </tr>
                    ...
                    <tr>
					  ...
					  <td align="center"  valign="middle"><div align="center" class="style5">
                       <a href="Server_UserProfile.jsp?type=<%="Server_UserPurchases"%>&uname=<%=s6%>" style="color:#006633"><b><%out.println(s6);%></b></a>
                      </div></td>
                      ...
                      <td align="center"  valign="middle"><div align="center" class="style82">
                        <a href="Server_ClothDetails.jsp?iname=<%=s3%>&id=<%=i%>" style="color:#CC0033"><b><%out.println(s3);%></b></a>
                      </div></td>
					  ...
					  <td align="center"  valign="middle"><div align="center" class="style11">
                          <b><%out.println(s9);%></b>
                      </div></td>
			      ...
			      <div align="left" class="style4">
			        ...
			        <p align="center">&nbsp;</p>
			        <p align="center"><strong><a href="ServerMain.jsp">Back</a></strong></p>
			      </div>
