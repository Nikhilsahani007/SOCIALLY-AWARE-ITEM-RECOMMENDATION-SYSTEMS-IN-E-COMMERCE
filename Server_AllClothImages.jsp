...
-->
               ...
               <tr bgcolor="#FFFFFF">
				 ...
				 <td  width="25" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="center" class="style4 style6" ><b>Seller Name</b></div></td>
            ...
            <%
					  ...
					  String s0="",s1="",s2="",s3="",s4="",s5="",s6="",s7="",s8="",s9="",s10="",seller="";
            ...
            <tr>
			  ...
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
			    ...
			    <td width="176" valign="middle" bgcolor="#FFFFFF"><div class="style9" style="margin:10px 13px 10px 13px;" >
			 ...
			 <td  width="105" align="left" valign="middle" height="23"><a href="Server_ViewFeedbacks.jsp?iname=<%=s1%>&id=<%=j%>" class="style8 style11">View Feedbacks</a> </td>
			 </tr>
            <%
					i=i+1;	
					...
					if(count==0){out.print("Sellers Have Not Uploaded any Cloth Images");}
