...
<%@ include file="connect.jsp" %>
		...
		<tr>
			<td  width="182" height="44" valign="middle" bgcolor="#FFFFFF" style="color:#000000;">
			   <div align="left" class="style10 style7 style9 style2" style="margin-left:20px;"><strong><em><a href="Server_ViewUserProfile.jsp?type=<%="Server_ViewFeedbacks"%>&uname=<%=r_user%>&iname=<%=iname%>&id=<%=one%>" style="color:#FF0033"> <%out.println(r_user);%> 
		    </a></em></strong></div></td>
...
<%					
					...
					<p>&nbsp;</p>
	         <div align="right" class="style22"><a href="Server_AllClothImages.jsp" class="style4">Back</a></div>
