...
<head>
<title>All Cloth Images Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600">All Cloth Images with Rank and Feedbacks..</h2>
          <div class="clr"></div>
          <div class="post_content">
		  <p>&nbsp;</p>
		  
		  
		  <iframe width="650" height="400" src="Server_AllClothImages.jsp"></iframe>
