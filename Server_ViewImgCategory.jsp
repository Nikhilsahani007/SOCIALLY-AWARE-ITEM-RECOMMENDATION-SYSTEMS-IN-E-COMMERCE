...
<head>
<title>Image Categories Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600">Image Categories..</h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
		  		<table width="250" border="1" align="left"  cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td  width="116" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style7"><b>Image Categories</b></div></td>
                    ...
                    <%
						...
						try 
						{
						   	String query="select * from img_category"; 
                      ...
                      <td height="0" align="center"  valign="middle"><div align="center" class="style5 style37 style54 style55 style22"><span class="style22" style="color:#000000">
                        <%out.println(i);%>
          			   ...
          			   <td height="0" align="center"  valign="middle"><div align="center" class="style5 style20 style37 style54 style55 style22">
                            <span class="style10" style="color:#FF3300">
                            <b><%out.println(s1);%></b>
                            </span></div></td>					
		          ...
		          <p align="left">&nbsp;</p>
		          <p align="left">&nbsp;</p>
		          <p align="left"><a href="Server_AddImgCategory.jsp" class="style16">Back</a></p>
