...
<head>
<title>Feedback Status Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600">Feedback Status..</h2>
          <div class="clr"></div>
...
PreparedStatement pst=connection.prepareStatement("insert into feedbacks(icat,iname,ruser,feedbacks,dt,imgid) values(?,?,?,?,?,?)");
             
			pst.setString(1,icat);
			...
			pst.executeUpdate();			
                  ...
                  %> 
<span class="style4 style1"> Feedback Submitted Successfully...</span>
  <p align="center"><a href="User_ClothImageDetails.jsp?iname=<%=iname%>&score=<%=sc%>&id=<%=one%>" class="style47">Back</a></p>
                  <%
