...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600">User <%=request.getParameter("uname")%>'s Profile.. </h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
            ...
            <%
				  ...
				  <h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("Server_GiveUserAuthorization")){%>
            <h3 align="right"><a href="Server_GiveUserAuthorization.jsp" class="style3 style5">Back</a></h3>
			<%}
			...
			<%}	
			else if(type.equalsIgnoreCase("Server_ViewFeedbacks")){%>
            <h3 align="right"><a href="Server_ViewFeedbacks.jsp" class="style5 style3">Back</a></h3>
			<%}	
			else if(type.equalsIgnoreCase("Server_UserPurchases")){%>
            <h3 align="right"><a href="Server_ViewAllUserPurchases.jsp" class="style5 style3">Back</a></h3>
			<%}	
