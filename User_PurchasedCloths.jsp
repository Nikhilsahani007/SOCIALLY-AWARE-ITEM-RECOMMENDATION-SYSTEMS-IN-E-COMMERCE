...
<head>
<title>Purchased Cloths Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600">Purchased Cloth Details..</h2>
          <div class="clr"></div>
		   ...
		   <p>&nbsp;</p>
           		<table width="600" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                    <tr>
					  ...
					  <td  width="94" valign="middle" style="color: #660033;"><div align="center" class="style13 style4"><b>Purchased Account No</b></div></td>
                    ...
                    <tr>
                      ...
                      <td align="center"  valign="middle"><div align="center" class="style82">
                        <a href="User_ClothDetails.jsp?iname=<%=s3%>&id=<%=i%>" style="color:#CC0033"><b><%out.println(s3);%></b></a>
                      </div></td>
