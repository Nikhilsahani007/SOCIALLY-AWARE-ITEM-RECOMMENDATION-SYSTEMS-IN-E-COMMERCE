...
<head>
<title>Cloth Image Rank In Chart Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600">All Cloth Image Rank In Chart..</h2>
          <div class="clr"></div>
          <div class="post_content">
		  <p>&nbsp;</p>
		  
		  			<iframe width="450" height="300" src="Server_ViewClothImgRankInChart1.jsp"></iframe>
			  				<br/>
