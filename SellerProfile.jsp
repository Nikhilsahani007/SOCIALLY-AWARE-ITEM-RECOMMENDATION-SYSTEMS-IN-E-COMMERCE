...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600"> <%=(String)application.getAttribute("sname")%>'s User <%=(String)application.getAttribute("suname")%>'s Profile</h2>
          <div class="clr"></div>
          <div class="post_content">
		   <p>&nbsp;</p>
            ...
            <%			
					...
					String user=(String)application.getAttribute("suname");
						...
						try 
						{
						   	String query="select * from suser where sname='"+sname+"' and username='"+user+"'"; 
            ...
            <%
					...
					%>
		  			...
		  			<p>&nbsp;</p>
				  <p align="right" class="style14"><a href="SellerMain.jsp" class="style13">Back</a></p>
