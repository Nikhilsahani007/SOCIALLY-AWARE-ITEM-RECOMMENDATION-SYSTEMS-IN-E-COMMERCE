          ...
          <div class="post_content">
		   <p>&nbsp;</p>
            ...
            <%
				  ...
				  <h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("User_ClothImageDetails")){%>
            <h3 align="right"><a href="User_ClothImageDetails.jsp?iname=<%=iname%>&score=<%=sc%>&id=<%=one%>" class="style4 style3">Back</a></h3>
			<%}
			else if(type.equalsIgnoreCase("User_Review")){%>
            <h3 align="right"><a href="User_Review.jsp" class="style4 style3">Back</a></h3>
			<%}	
