...
<head>
<title>User Register Status Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#CC6600">User Registration Status..</h2>
          <div class="clr"></div>
          <div class="post_content">
		   <p>&nbsp;</p>
             <%
					...
					String paramname=null,uname=null,pass=null,email=null,mno=null,addr=null,dob=null,gender=null,image=null,cloud=null,bin = "";
		          ...
		          <p align="center" class="style4 style9" style="color:#000000">User Name Already Exist..</p>
		          <p align="center"><a href="UserRegister.jsp" class="style5 style16 style35">Back</a></p>
		          <%
...
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,status,image) values(?,?,?,?,?,?,?,?,?)");
						...
						{
						%>
                  <p align="center" class="style10" style="color:#000000">User Registration Successfull.</p>
		          <p class="style19">&nbsp;</p>
		          <p align="center"><a href="UserLogin.jsp" class="style16">Back</a></p>
		          <%
